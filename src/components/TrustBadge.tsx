    ...
    <div className="bg-gray-50 border border-gray-200 rounded-lg p-5 mb-8">
      ...
      <div className="flex items-start gap-2 text-gray-600 text-sm">
        ...
        <p className="leading-relaxed">
          Calculations are rooted in standard financial formulas and are provided as educational estimates only. They do not constitute professional financial advice. Results may vary based on actual interest rates and fees. You should verify all numbers with a certified financial professional prior to making significant financial commitments. <Link href="/editorial-policy" className="text-blue-600 hover:underline inline-flex items-center whitespace-nowrap">Read our editorial commitment <span className="ml-1">→</span></Link>
        </p>
      </div>
    </div>
  );
