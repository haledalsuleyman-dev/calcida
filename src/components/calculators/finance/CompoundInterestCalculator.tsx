      ...
      <div className="lg:col-span-4 space-y-6">
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
          <div className="space-y-4">
            ...
            <div>
              <Label htmlFor="annualRate">Estimated Annual Return (%)</Label>
              <Input
                id="annualRate"
                type="number"
                step="0.1"
      ...
      <div className="lg:col-span-8 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-blue-50 p-6 rounded-lg border border-blue-100 text-center">
            <h2 className="text-sm font-semibold text-blue-900 mb-1 uppercase tracking-wider">Future Value</h2>
            <div className="text-3xl font-bold text-blue-700">
              {formatCurrency(result.finalBalance)}
            </div>
          </div>
          <div className="bg-green-50 p-6 rounded-lg border border-green-100 text-center">
            <h2 className="text-sm font-semibold text-green-900 mb-1 uppercase tracking-wider">Total Principal</h2>
          ...
          <div className="bg-purple-50 p-6 rounded-lg border border-purple-100 text-center">
            <h2 className="text-sm font-semibold text-purple-900 mb-1 uppercase tracking-wider">Total Interest</h2>
        ...
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm h-[400px] min-h-[400px]">
          <h3 className="text-lg font-semibold mb-4 text-center">Wealth Growth Over Time</h3>
