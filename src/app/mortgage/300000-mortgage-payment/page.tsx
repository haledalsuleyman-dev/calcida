...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: '/mortgage/300000-mortgage-payment',
    type: 'article',
  },
};

export default function Mortgage300kPaymentPage() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      <div className="mb-10">
        <h1 className="text-4xl font-bold mb-6 text-gray-900">$300,000 Mortgage Payment Breakdown</h1>
        <MortgagePaymentArticle loanAmount={300000} />
      </div>
      ...
      <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm mb-12">
        ...
        <MortgageCalculator defaultValues={{ homePrice: 300000, downPayment: 0, paymentFrequency: 'monthly' }} />
      </div>
    </div>
  );
}
